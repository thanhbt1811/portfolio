...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡ Build cross-platform mobile applications using frameworks Flutter, ensuring code reusability and wider reach"
    ),
    emoji(
      "⚡ Seamlessly integrate Backend-as-a-Service (BaaS) platforms such as Firebase, AWS Amplify, and others to power your mobile app functionalities."
    )
  ],
